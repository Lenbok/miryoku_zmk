...
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              &kp PLUS,          &kp NUM_4,         &kp NUM_5,         &kp NUM_6,         &kp SEMI,          \
...
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              &kp EQL,           &kp DLLR,          &kp PRCT,          &kp CRRT,          &kp COLON,         \
